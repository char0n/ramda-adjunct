...
describe('reduceP', function () {
  ...
  it('tests initial value for promise', function () {
    const testAdd = RA.reduceP(R.add, Promise.resolve(0), [1, 2, 3, 4])
      .then(actual => eq(actual, 10));
    const testMultiply = RA.reduceP(R.multiply, Promise.resolve(1), [1, 2, 3, 4])
  ...
  it('tests iterator wrapped in promise containing values and promises', function () {
    return RA.reduceP(R.add, 0, Promise.resolve([1, Promise.resolve(2), 3]))
